...
class RolloutGenerator(object):
    ...
    def __init__(self, mdir, device, time_limit):
        ...
        self.env = normalize(SOFTGYM_ENVS[env_name](**env_kwargs))


        self.device = device

        # self.time_limit = time_limit
        self.time_limit = 100 #clothfold horizon limit from softgym
    ...
    def rollout(self, params, render=False):
        ...
        frames = [self.env.get_image(64, 64)] #softgym shid
